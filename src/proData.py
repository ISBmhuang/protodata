...
riboreps = pd.ExcelFile(path+"riboreps.xlsx")

riborep1 = riboreps.parse("riborep1")
riborep2 = riboreps.parse("riborep2")
riborep3 = riboreps.parse("riborep3")
...
plt.savefig('log2ratiosvstp_proteomics.png', format='png', dpi=3000)
