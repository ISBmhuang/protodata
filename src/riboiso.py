...
rep1 = data.parse("Ribosome_Isolation_BR1", parse_cols=[0,2,6,10])
rep2 = data.parse("Ribosome_Isolation_BR2", parse_cols=[0,2,6,10])
rep3 = data.parse("Ribosome_Isolation_BR3", parse_cols=[0,2,6,10])
...
riborep1file = open('riboisorep1.txt', 'w')
for item in ribodata1:
    riborep1file.write("%s\n" % item)

riborep2file = open('riboisorep2.txt', 'w')
for item in ribodata2:
    riborep2file.write("%s\n" % item)

riborep3file = open('riboisorep3.txt', 'w')
